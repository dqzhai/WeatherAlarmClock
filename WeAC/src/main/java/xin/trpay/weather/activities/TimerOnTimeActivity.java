...
public class TimerOnTimeActivity extends BaseActivitySimple implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(xin.trpay.weather.R.layout.activity_timer_on_time);
    ...
    private void playRing() {
        ...
        switch (ringUrl) {
            case WeacConstants.DEFAULT_RING_URL:
                AudioPlayer.getInstance(this).playRaw(xin.trpay.weather.R.raw.ring_weac_alarm_clock_default, true, false);
                break;
            // 无铃声
    ...
    private void initViews() {
        Button rogerBtn = (Button) findViewById(xin.trpay.weather.R.id.roger_btn);
