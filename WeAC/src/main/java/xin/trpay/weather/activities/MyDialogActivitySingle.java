...
public class MyDialogActivitySingle extends BaseActivitySimple {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(xin.trpay.weather.R.layout.activity_my_dialog_single);
    ...
    private void initViews() {
        // 确定按钮
        Button sureBtn = (Button) findViewById(xin.trpay.weather.R.id.dialog_sure_btn);
        ...
        // 标题
        TextView titleTv = (TextView) findViewById(xin.trpay.weather.R.id.dialog_title);
        // 详情
        TextView detailTv = (TextView) findViewById(xin.trpay.weather.R.id.dialog_detail);
