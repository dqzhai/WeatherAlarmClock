...
public class ToastUtil {
    ...
    private static void showToast(Context appContext, String msg, int duration, int delayMillis) {
        ...
        View view = inflater.inflate(xin.trpay.weather.R.layout.toast, new LinearLayout(appContext),
                false);
        TextView tv = (TextView) view.findViewById(xin.trpay.weather.R.id.toast_tv);
        tv.setText(msg);
