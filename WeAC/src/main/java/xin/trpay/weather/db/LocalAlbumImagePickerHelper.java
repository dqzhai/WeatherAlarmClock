...
import xin.trpay.weather.bean.ImageBucket;
...
public class LocalAlbumImagePickerHelper {
    ...
    private void buildImagesBucketList() {
        ...
        mImageBucketRecent.bucketName = mContext.getString(xin.trpay.weather.R.string.recent);
    ...
    private String changeLocalName(String name) {
        if (name.equalsIgnoreCase("Camera")) {
            name = mContext.getString(xin.trpay.weather.R.string.camera);
        } else if (name.equalsIgnoreCase("Screenshots")) {
            name = mContext.getString(xin.trpay.weather.R.string.screen_short);
        } else if (name.equalsIgnoreCase("Weixin")) {
            name = mContext.getString(xin.trpay.weather.R.string.we_chat);
        } else if (name.equalsIgnoreCase("save")) {
            name = mContext.getString(xin.trpay.weather.R.string.save);
        } else if (name.equalsIgnoreCase("download")) {
            name = mContext.getString(xin.trpay.weather.R.string.download);
        } else if (name.equalsIgnoreCase("Pictures")) {
            name = mContext.getString(xin.trpay.weather.R.string.picture);
        }
        return name;
    }
