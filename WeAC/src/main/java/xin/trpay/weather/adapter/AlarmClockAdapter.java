...
import xin.trpay.weather.util.AudioPlayer;
...
public class AlarmClockAdapter extends RecyclerView.Adapter<AlarmClockAdapter.MyViewHolder> {
    ...
    public AlarmClockAdapter(Context context, List<AlarmClock> objects) {
        ...
        mWhiteTrans = mContext.getResources().getColor(xin.trpay.weather.R.color.white_trans30);
    }

    @Override
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new MyViewHolder(LayoutInflater.from(mContext).inflate(
                xin.trpay.weather.R.layout.lv_alarm_clock, parent, false));
    }
...
//                                alarmClock.getAlarmClockCode());
    ...
    class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View itemView) {
            super(itemView);
            rippleView = (MaterialRippleLayout) itemView.findViewById(xin.trpay.weather.R.id.ripple_view);
            time = (TextView) itemView.findViewById(xin.trpay.weather.R.id.tv_time);
            repeat = (TextView) itemView.findViewById(xin.trpay.weather.R.id.tv_repeat);
            tag = (TextView) itemView.findViewById(xin.trpay.weather.R.id.tv_tag);
            toggleBtn = (ToggleButton) itemView.findViewById(xin.trpay.weather.R.id.toggle_btn);
            deleteBtn = (ImageView) itemView.findViewById(xin.trpay.weather.R.id.alarm_list_delete_btn);
        }
    }
