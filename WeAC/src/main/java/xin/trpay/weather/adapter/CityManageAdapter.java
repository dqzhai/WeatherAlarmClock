 ...
 *
 */
package xin.trpay.weather.adapter;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(mContext).inflate(
                    xin.trpay.weather.R.layout.gv_city_manage, parent, false);
            viewHolder = new ViewHolder();
            viewHolder.background = (ViewGroup) convertView.findViewById(xin.trpay.weather.R.id.background);
            viewHolder.cityWeather = (ViewGroup) convertView
                    .findViewById(xin.trpay.weather.R.id.city_weather);
            viewHolder.cityName = (TextView) convertView
                    .findViewById(xin.trpay.weather.R.id.city_name);
            viewHolder.weatherTypeIv = (ImageView) convertView
                    .findViewById(xin.trpay.weather.R.id.weather_type_iv);
            viewHolder.tempHigh = (TextView) convertView
                    .findViewById(xin.trpay.weather.R.id.temp_high);
            viewHolder.tempLow = (TextView) convertView
                    .findViewById(xin.trpay.weather.R.id.temp_low);
            viewHolder.weatherTypeTv = (TextView) convertView
                    .findViewById(xin.trpay.weather.R.id.weather_type_tv);
            viewHolder.setDefaultTv = (TextView) convertView
                    .findViewById(xin.trpay.weather.R.id.set_default);
            viewHolder.addCityIv = (ImageView) convertView
                    .findViewById(xin.trpay.weather.R.id.add_city);
            convertView.setTag(viewHolder);
            viewHolder.deleteCityBtn = (ImageView) convertView.findViewById(xin.trpay.weather.R.id.city_delete_btn);
            viewHolder.progressBar = (ProgressBar) convertView.findViewById(xin.trpay.weather.R.id.progress_bar);
        } else {
...
/*                if (cityManage.getWeatherType().equals(mContext.getString(R.string.no))) {
                ...
                if (cityManage.getLocationCity() == null) {
                    ...
                    weatherCode = mContext.getString(xin.trpay.weather.R.string.auto_location);
                }
        ...
        if (cityName != null && mDefaultCity.equals(cityName)) {
            viewHolder.setDefaultTv.setBackgroundDrawable(mContext.getResources().getDrawable(
                    xin.trpay.weather.R.drawable.bg_gv_city_manage_default));
            viewHolder.setDefaultTv.setText(xin.trpay.weather.R.string.my_default);
        } else {
            viewHolder.setDefaultTv.setBackgroundDrawable(mContext.getResources().getDrawable(
                    xin.trpay.weather.R.drawable.bg_gv_city_manage_set_default));
            viewHolder.setDefaultTv.setText(xin.trpay.weather.R.string.set_default);
        }
        ...
        if (cityManage.getLocationCity() == null) {
            ...
            Drawable drawable = mContext.getResources().getDrawable(xin.trpay.weather.R.drawable.ic_gps);
            if (drawable != null) {
