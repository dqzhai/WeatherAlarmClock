 ...
 *
 */
package xin.trpay.weather.view;
...
//        LogUtil.d(LOG_TAG, "绘制中");
    ...
    private void initialize(Canvas canvas) {
        ...
        // 表盘外圈颜色
        int colorWatcher = getResources().getColor(xin.trpay.weather.R.color.white_trans10);
        ...
        int colorDragging = getResources().getColor(xin.trpay.weather.R.color.white_trans20);
