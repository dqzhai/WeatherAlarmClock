...
public class LineChartViewDouble extends View {
    ...
    private void init() {
        ...
        mColorDay = getResources().getColor(xin.trpay.weather.R.color.yellow_hot);
        mColorNight = getResources().getColor(xin.trpay.weather.R.color.blue_ice);
        //  字体颜色
        int textColor = getResources().getColor(xin.trpay.weather.R.color.white_trans90);
