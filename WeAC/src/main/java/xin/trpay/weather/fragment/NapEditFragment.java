...
public class NapEditFragment extends BaseFragment implements OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View view = inflater.inflate(xin.trpay.weather.R.layout.fm_nap_edit, container,
                false);
        // 设置Dialog全屏显示
        ...
        RadioGroup napIntervalRg = (RadioGroup) view
                .findViewById(xin.trpay.weather.R.id.nap_interval_radio_group);
        // 设置默认选中的小睡间隔按钮Id
        ...
        RadioGroup napTimesRg = (RadioGroup) view
                .findViewById(xin.trpay.weather.R.id.nap_times_radio_group);
        // 设置默认选中的小睡次数按钮Id
        initNapTimesRbtnId();
        ...
        // 取消按钮
        Button cancelBtn = (Button) view.findViewById(xin.trpay.weather.R.id.cancel_btn);
        cancelBtn.setOnClickListener(this);

        // 完成按钮
        Button finishBtn = (Button) view.findViewById(xin.trpay.weather.R.id.sure_btn);
    ...
    private void initNapTimesRbtnId() {
        switch (mNapTimes) {
            case 1:
                mNapTimesRbtnId = xin.trpay.weather.R.id.nap_times_btn1;
                break;
            case 3:
                mNapTimesRbtnId = xin.trpay.weather.R.id.nap_times_btn3;
                break;
            case 5:
                mNapTimesRbtnId = xin.trpay.weather.R.id.nap_times_btn5;
                break;
            case 8:
                mNapTimesRbtnId = xin.trpay.weather.R.id.nap_times_btn8;
                break;
            case 10:
                mNapTimesRbtnId = xin.trpay.weather.R.id.nap_times_btn10;
                break;
            default:
                mNapTimesRbtnId = xin.trpay.weather.R.id.nap_times_btn3;
                break;
    ...
    private void initNapIntervalRbtnId() {
        switch (mNapInterval) {
            case 5:
                mNapIntervalRbtnId = xin.trpay.weather.R.id.nap_interval_btn5;
                break;
            case 10:
                mNapIntervalRbtnId = xin.trpay.weather.R.id.nap_interval_btn10;
                break;
            case 20:
                mNapIntervalRbtnId = xin.trpay.weather.R.id.nap_interval_btn20;
                break;
            case 30:
                mNapIntervalRbtnId = xin.trpay.weather.R.id.nap_interval_btn30;
                break;
            case 60:
                mNapIntervalRbtnId = xin.trpay.weather.R.id.nap_interval_btn60;
                break;
            default:
                mNapIntervalRbtnId = xin.trpay.weather.R.id.nap_interval_btn10;
                break;
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case xin.trpay.weather.R.id.cancel_btn:
                ...
                break;
            // 完成按钮
            case xin.trpay.weather.R.id.sure_btn:
