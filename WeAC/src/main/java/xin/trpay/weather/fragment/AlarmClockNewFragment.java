 ...
 *
 */
package xin.trpay.weather.fragment;
...
import xin.trpay.weather.activities.NapEditActivity;
import xin.trpay.weather.activities.RingSelectActivity;
import xin.trpay.weather.bean.AlarmClock;
import xin.trpay.weather.common.WeacConstants;
...
public class AlarmClockNewFragment extends BaseFragment implements OnClickListener,
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(xin.trpay.weather.R.layout.fm_alarm_clock_new_edit,
                container, false);
        // 设置界面背景
        setBackground(view);
//        setBounce(view);
    ...
    private void setBounce(View view) {
        ScrollView scrollView = (ScrollView) view.findViewById(xin.trpay.weather.R.id.scrollView1);
    ...
    private void initVolume(View view) {
        ...
        // 音量控制seekBar
        SeekBar volumeSkBar = (SeekBar) view.findViewById(xin.trpay.weather.R.id.volumn_sk);
        // 设置当前音量显示
    ...
    private void setBackground(View view) {
        // 新建闹钟界面
        ViewGroup viewGroup = (ViewGroup) view.findViewById(xin.trpay.weather.R.id.new_alarm_clock_llyt);
        // 设置页面背景
    ...
    private void initActionBar(View view) {
        // 操作栏取消按钮
        ImageView cancelAction = (ImageView) view.findViewById(xin.trpay.weather.R.id.action_cancel);
        cancelAction.setOnClickListener(this);
        // 操作栏确定按钮
        ImageView acceptAction = (ImageView) view.findViewById(xin.trpay.weather.R.id.action_accept);
        acceptAction.setOnClickListener(this);
        // 操作栏标题
        TextView actionTitle = (TextView) view.findViewById(xin.trpay.weather.R.id.action_title);
        actionTitle.setText(getString(xin.trpay.weather.R.string.new_alarm_clock));
    }
    ...
    private void initTimeSelect(View view) {
        // 下次响铃提示
        mTimePickerTv = (TextView) view.findViewById(xin.trpay.weather.R.id.time_picker_tv);
        countDown = getResources()
                .getString(xin.trpay.weather.R.string.countdown_day_hour_minute);
//        // 设置下次响铃时间提示内容
//        mTimePickerTv.setText(String.format(countDown, 1, 0, 0));

        // 闹钟时间选择器
        TimePicker timePicker = (TimePicker) view.findViewById(xin.trpay.weather.R.id.time_picker);
    ...
    private void initRepeat(View view) {
        // 初始化闹钟实例的重复
        mAlarmClock.setRepeat(getString(xin.trpay.weather.R.string.repeat_once));
        mAlarmClock.setWeeks(null);

        // 重复描述
        mRepeatDescribe = (TextView) view.findViewById(xin.trpay.weather.R.id.repeat_describe);
        mRepeatStr = new StringBuilder();
        mMap = new TreeMap<>();

        // 周选择按钮
        // 周一按钮
        ToggleButton monday = (ToggleButton) view.findViewById(xin.trpay.weather.R.id.tog_btn_monday);
        // 周二按钮
        ToggleButton tuesday = (ToggleButton) view.findViewById(xin.trpay.weather.R.id.tog_btn_tuesday);
        // 周三按钮
        ToggleButton wednesday = (ToggleButton) view.findViewById(xin.trpay.weather.R.id.tog_btn_wednesday);
        // 周四按钮
        ToggleButton thursday = (ToggleButton) view.findViewById(xin.trpay.weather.R.id.tog_btn_thursday);
        // 周五按钮
        ToggleButton friday = (ToggleButton) view.findViewById(xin.trpay.weather.R.id.tog_btn_friday);
        // 周六按钮
        ToggleButton saturday = (ToggleButton) view.findViewById(xin.trpay.weather.R.id.tog_btn_saturday);
        // 周日按钮
        ToggleButton sunday = (ToggleButton) view.findViewById(xin.trpay.weather.R.id.tog_btn_sunday);
    ...
    private void initTag(View view) {
        // 初始化闹钟实例的标签
        mAlarmClock.setTag(getString(xin.trpay.weather.R.string.alarm_clock));

        // 标签描述控件
        EditText tag = (EditText) view.findViewById(xin.trpay.weather.R.id.tag_edit_text);
    ...
    private void initRing(View view) {
        ...
        String ringName = share.getString(WeacConstants.RING_NAME,
                getString(xin.trpay.weather.R.string.default_ring));
        ...
        // 铃声控件
        ViewGroup ring = (ViewGroup) view.findViewById(xin.trpay.weather.R.id.ring_llyt);
        mRingDescribe = (TextView) view.findViewById(xin.trpay.weather.R.id.ring_describe);
    ...
    private void initToggleButton(View view) {
        ...
        // 振动
        ToggleButton vibrateBtn = (ToggleButton) view.findViewById(xin.trpay.weather.R.id.vibrate_btn);

        // 小睡
        ToggleButton napBtn = (ToggleButton) view.findViewById(xin.trpay.weather.R.id.nap_btn);
        // 小睡组件
        ViewGroup nap = (ViewGroup) view.findViewById(xin.trpay.weather.R.id.nap_llyt);
        nap.setOnClickListener(this);

        // 天气提示
        ToggleButton weaPromptBtn = (ToggleButton) view.findViewById(xin.trpay.weather.R.id.wea_prompt_btn);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            // 当点击取消按钮
            case xin.trpay.weather.R.id.action_cancel:
                drawAnimation();
                break;
            // 当点击确认按钮
            case xin.trpay.weather.R.id.action_accept:
                ...
                break;
            // 当点击铃声
            case xin.trpay.weather.R.id.ring_llyt:
                // 不响应重复点击
                ...
                break;
            // 当点击小睡
            case xin.trpay.weather.R.id.nap_llyt:
                // 不响应重复点击
                if (MyUtil.isFastDoubleClick()) {
                    return;
                }
    ...
    private void drawAnimation() {
        getActivity().finish();
        getActivity().overridePendingTransition(0, xin.trpay.weather.R.anim.zoomout);
    }
    ...
    public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
        switch (buttonView.getId()) {
            // 选中周一
            case xin.trpay.weather.R.id.tog_btn_monday:
                if (isChecked) {
                    isMondayChecked = true;
                    mMap.put(1, getString(xin.trpay.weather.R.string.one_h));
                    setRepeatDescribe();
                    displayCountDown();
                } else {
                ...
                break;
            // 选中周二
            case xin.trpay.weather.R.id.tog_btn_tuesday:
                if (isChecked) {
                    isTuesdayChecked = true;
                    mMap.put(2, getString(xin.trpay.weather.R.string.two_h));
                    setRepeatDescribe();
                    displayCountDown();
                } else {
                ...
                break;
            // 选中周三
            case xin.trpay.weather.R.id.tog_btn_wednesday:
                if (isChecked) {
                    isWednesdayChecked = true;
                    mMap.put(3, getString(xin.trpay.weather.R.string.three_h));
                    setRepeatDescribe();
                    displayCountDown();
                } else {
                ...
                break;
            // 选中周四
            case xin.trpay.weather.R.id.tog_btn_thursday:
                if (isChecked) {
                    isThursdayChecked = true;
                    mMap.put(4, getString(xin.trpay.weather.R.string.four_h));
                    setRepeatDescribe();
                    displayCountDown();
                } else {
                ...
                break;
            // 选中周五
            case xin.trpay.weather.R.id.tog_btn_friday:
                if (isChecked) {
                    isFridayChecked = true;
                    mMap.put(5, getString(xin.trpay.weather.R.string.five_h));
                    setRepeatDescribe();
                    displayCountDown();
                } else {
                ...
                break;
            // 选中周六
            case xin.trpay.weather.R.id.tog_btn_saturday:
                if (isChecked) {
                    isSaturdayChecked = true;
                    mMap.put(6, getString(xin.trpay.weather.R.string.six_h));
                    setRepeatDescribe();
                    displayCountDown();
                } else {
                ...
                break;
            // 选中周日
            case xin.trpay.weather.R.id.tog_btn_sunday:
                if (isChecked) {
                    isSundayChecked = true;
                    mMap.put(7, getString(xin.trpay.weather.R.string.day));
                    setRepeatDescribe();
                    displayCountDown();
                } else {
                ...
                break;
            // 振动
            case xin.trpay.weather.R.id.vibrate_btn:
                if (isChecked) {
                ...
                break;
            // 小睡
            case xin.trpay.weather.R.id.nap_btn:
                if (isChecked) {
                    mAlarmClock.setNap(true);
                } else {
                ...
                break;
            // 天气提示
            case xin.trpay.weather.R.id.wea_prompt_btn:
                if (isChecked) {
                    mAlarmClock.setWeaPrompt(true);
                } else {
    ...
    private void setRepeatDescribe() {
        ...
        if (isMondayChecked & isTuesdayChecked & isWednesdayChecked
            ...
            mRepeatDescribe.setText(getResources()
                    .getString(xin.trpay.weather.R.string.every_day));
            mAlarmClock.setRepeat(getString(xin.trpay.weather.R.string.every_day));
            // 响铃周期
            ...
            // 周一到周五全部选中
                ...
                & isThursdayChecked & isFridayChecked & !isSaturdayChecked
                & !isSundayChecked) {
            mRepeatDescribe.setText(getString(xin.trpay.weather.R.string.week_day));
            mAlarmClock.setRepeat(getString(xin.trpay.weather.R.string.week_day));
            mAlarmClock.setWeeks("2,3,4,5,6");
            // 周六、日全部选中
        } else if (!isMondayChecked & !isTuesdayChecked & !isWednesdayChecked
                & !isThursdayChecked & !isFridayChecked & isSaturdayChecked
                & isSundayChecked) {
            mRepeatDescribe.setText(getString(xin.trpay.weather.R.string.week_end));
            mAlarmClock.setRepeat(getString(xin.trpay.weather.R.string.week_end));
            mAlarmClock.setWeeks("7,1");
            // 没有选中任何一个
        } else if (!isMondayChecked & !isTuesdayChecked & !isWednesdayChecked
                & !isThursdayChecked & !isFridayChecked & !isSaturdayChecked
                & !isSundayChecked) {
            mRepeatDescribe.setText(getString(xin.trpay.weather.R.string.repeat_once));
            mAlarmClock.setRepeat(getResources()
                    .getString(xin.trpay.weather.R.string.repeat_once));
            mAlarmClock.setWeeks(null);

        } else {
            mRepeatStr.setLength(0);
            mRepeatStr.append(getString(xin.trpay.weather.R.string.week));
            Collection<String> col = mMap.values();
            for (String aCol : col) {
                mRepeatStr.append(aCol).append(getResources().getString(xin.trpay.weather.R.string.caesura));
            }
            // 去掉最后一个"、"
    ...
    private void displayCountDown() {
        ...
        if (remainDay > 0) {
            countDown = getString(xin.trpay.weather.R.string.countdown_day_hour_minute);
            mTimePickerTv.setText(String.format(countDown, remainDay,
                    remainHour, remainMinute));
            // 当剩余小时大于0时显示【X小时X分】格式
        } else if (remainHour > 0) {
            countDown = getResources()
                    .getString(xin.trpay.weather.R.string.countdown_hour_minute);
            mTimePickerTv.setText(String.format(countDown, remainHour,
                    remainMinute));
        } else {
            // 当剩余分钟不等于0时显示【X分钟】格式
            if (remainMinute != 0) {
                countDown = getString(xin.trpay.weather.R.string.countdown_minute);
