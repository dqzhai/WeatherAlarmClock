...
public class RecordDetailFragment extends BaseFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            mPlayDuration = getString(xin.trpay.weather.R.string.unknown);
    ...
    public View onCreateView(LayoutInflater inflater,
        ...
        View view = inflater.inflate(xin.trpay.weather.R.layout.fm_record_detail, container,
                false);
        // 设置Dialog全屏显示
        getActivity().getWindow().setLayout(LayoutParams.MATCH_PARENT,
                LayoutParams.WRAP_CONTENT);
        // 文件名称TextView
        TextView fileNameTv = (TextView) view.findViewById(xin.trpay.weather.R.id.fime_name);
        // 文件格式TextView
        TextView fileFormatTv = (TextView) view.findViewById(xin.trpay.weather.R.id.fime_format);
        // 文件大小TextView
        TextView fileSizeTv = (TextView) view.findViewById(xin.trpay.weather.R.id.fime_size);
        // 修改时间TextView
        TextView modifyTimeTv = (TextView) view.findViewById(xin.trpay.weather.R.id.modify_time);
        // 播放时长TextView
        TextView playDurationTv = (TextView) view.findViewById(xin.trpay.weather.R.id.play_duration);
        // 保存路径TextView
        TextView savePathTv = (TextView) view.findViewById(xin.trpay.weather.R.id.save_path);
        // 知道了Button
        Button rogerBtn = (Button) view.findViewById(xin.trpay.weather.R.id.roger_btn);
        ...
        fileFormatTv.setText(getString(xin.trpay.weather.R.string.amr));
