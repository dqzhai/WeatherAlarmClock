...
import xin.astuetz.PagerSlidingTabStrip;
import xin.trpay.weather.bean.RingSelectItem;
...
public class RingSelectFragment extends BaseFragment implements OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(xin.trpay.weather.R.layout.fm_ring_select, container, false);
        // 铃声选择界面
        ViewGroup viewGroup = (ViewGroup) view.findViewById(xin.trpay.weather.R.id.ring_select_llyt);
        // 设置页面背景
        ...
        // 返回按钮
        ImageView actionCancel = (ImageView) view.findViewById(xin.trpay.weather.R.id.ring_select_cancel);
        actionCancel.setOnClickListener(this);

        // 保存按钮
        TextView actionSave = (TextView) view.findViewById(xin.trpay.weather.R.id.ring_select_save);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            // 当点击返回按钮
            case xin.trpay.weather.R.id.ring_select_cancel:
                getActivity().finish();
                break;
            // 当点击保存按钮
            case xin.trpay.weather.R.id.ring_select_save:
                // 取得选中的铃声信息
...
//      铃声种类
        ViewPager viewPager = (ViewPager) view
                .findViewById(xin.trpay.weather.R.id.fragment_ring_select_sort);
        ...
        PagerSlidingTabStrip strip = (PagerSlidingTabStrip) view
                .findViewById(xin.trpay.weather.R.id.tabstrip);
    ...
    private class MyFragmentPagerAdapter extends FragmentPagerAdapter {
         ...
         * 铃声选择列表标题
         */
        private final String[] titles = {getString(xin.trpay.weather.R.string.system_ring),
                getString(xin.trpay.weather.R.string.local_music), getString(xin.trpay.weather.R.string.record)};
